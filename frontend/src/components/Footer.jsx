...
import { Phone, Mail, MapPin, FileText, Users, Play } from 'lucide-react'
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-6">
            <div className="flex items-center">
              ...
              <span className="text-xl font-bold">ASM RIGHTS</span>
            </div>
            
            <p className="text-gray-300 text-sm leading-relaxed">
              Автоматизированная система управления авторскими правами для авторов, 
              правообладателей и инвесторов.
            </p>
          ...
          {/* Navigation Links */}
          <div>
            <h3 className="text-lg font-semibold mb-6">Главная</h3>
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Каталог</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Услуги</a></li>
          ...
          {/* More Links */}
          <div>
            <h3 className="text-lg font-semibold mb-6">Новости</h3>
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Реклама</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Правовая база</a></li>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="space-y-1">
                  <p className="text-gray-300 text-sm">8-800-100-55-44</p>
                  <p className="text-gray-300 text-sm">8-800-100-55-02</p>
                </div>
              </div>
              
              <div className="flex items-center space-x-3">
                <Mail className="h-5 w-5 text-gray-400" />
                <p className="text-gray-300 text-sm">asmrightsholder@gmail.com</p>
              </div>
            </div>
          </div>
        </div>
